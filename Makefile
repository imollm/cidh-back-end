...
help:
	...
	@echo "db-create       	- Create the schema (Need Flyway installed in local)."
	@echo "db-drop       	- Drop the schema (Need Flyway installed in local)."
	@echo "db-migrate       - Migrate schema tables (Need Flyway installed in local)."
	@echo "db-seed       	- Seed tables with mock data (Need Flyway installed in local)."
	@echo "db-clean       	- Clean schema, drop all tables (Need Flyway installed in local)."
	@echo ""
	@echo "API COMMANDS"
