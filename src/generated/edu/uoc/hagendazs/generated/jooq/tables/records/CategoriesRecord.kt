...
open class CategoriesRecord() : UpdatableRecordImpl<CategoriesRecord>(Categories.CATEGORIES), Record4<String?, String?, String?, LocalDateTime?> {
    ...
    override fun field1(): Field<String?> = Categories.CATEGORIES.ID
    override fun field2(): Field<String?> = Categories.CATEGORIES.NAME
    override fun field3(): Field<String?> = Categories.CATEGORIES.DESCRIPTION
    override fun field4(): Field<LocalDateTime?> = Categories.CATEGORIES.CREATED_AT
    ...
    override fun value1(value: String?): CategoriesRecord {
        this.id = value
        return this
    }

    override fun value2(value: String?): CategoriesRecord {
        this.name = value
        return this
    }

    override fun value3(value: String?): CategoriesRecord {
        this.description = value
        return this
    }

    override fun value4(value: LocalDateTime?): CategoriesRecord {
        this.createdAt = value
        return this
    }

    override fun values(value1: String?, value2: String?, value3: String?, value4: LocalDateTime?): CategoriesRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
