...
open class LabelRecord() : UpdatableRecordImpl<LabelRecord>(Label.LABEL), Record4<String?, String?, String?, LocalDateTime?> {
    ...
    override fun field1(): Field<String?> = Label.LABEL.ID
    override fun field2(): Field<String?> = Label.LABEL.NAME
    override fun field3(): Field<String?> = Label.LABEL.DESCRIPTION
    override fun field4(): Field<LocalDateTime?> = Label.LABEL.CREATED_AT
    ...
    override fun value3(value: String?): LabelRecord {
        this.description = value
        return this
    }

    override fun value4(value: LocalDateTime?): LabelRecord {
        this.createdAt = value
        return this
    }

    override fun values(value1: String?, value2: String?, value3: String?, value4: LocalDateTime?): LabelRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
